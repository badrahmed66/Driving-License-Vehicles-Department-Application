	...
	public class ApplicationDAL
	{
		...
		static public List<ApplicationDTO> RetrieveApplicationsWithFilter(string filterColumn = "", string filterValue = "")
		{
			...
			catch (Exception e)
			{
				...
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(RetrieveApplicationsWithFilter), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource,LogFile.StringFormat(nameof(ApplicationDAL), nameof(RetrieveApplicationsWithFilter),e.Message));
		...
		static public ApplicationDTO FindApplicatioinByID(int appID)
		{
			...
			catch (Exception e)
			{
				...
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(FindApplicatioinByID), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(FindApplicatioinByID), e.Message));
				return null;
			}
		}
		...
		static public int InsertApplication(ApplicationDTO app)
		{
			...
			{
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(InsertApplication), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(InsertApplication), e.Message));
				return -1;
			}
		}
		...
		static public bool UpdateApplication(ApplicationDTO app)
		{
			...
			{
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(UpdateApplication), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(UpdateApplication), e.Message));
				return false;
			}
		}
		...
		static public bool DeleteApplication(int appID)
		{
			...
			{
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(DeleteApplication), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(DeleteApplication), e.Message));
				return false;
			}
		}
		...
		public static bool UpdateStatus(int appID, byte appStatus)
		{
			...
			{
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(UpdateStatus), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(UpdateStatus), e.Message));
				return false;
			}
		}
		...
		public static int GetActiveAppID(int personID, int appTypeID)
		{
			...
			{
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(GetActiveAppID), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(GetActiveAppID), e.Message));
				return -1;
			}
		}
		...
		public static bool IsExist(int applicationID)
		{
			...
			{
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(IsExist), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(IsExist), e.Message));
				return false;
			}
		}
		...
		public static int GetActiveAppIDForSpecificLicense(int personID, int appTypeID, int licenseID)
		{
			...
			{
				LogFile.AddLogToFile(nameof(ApplicationDAL), nameof(GetActiveAppIDForSpecificLicense), e.Message, LogFile.ErrorsFile);

				EventLog.WriteEntry(LogFile.eventLogSource, LogFile.StringFormat(nameof(ApplicationDAL), nameof(GetActiveAppIDForSpecificLicense), e.Message));
				return -1;
			}
		}
